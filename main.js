...
async function petsArea() {
  const petsPromise = await fetch("https://shiny-pudding-8d6285.netlify.app/.netlify/functions/pets")
  ...
  petsData.forEach(pet => {
    ...
    if (!pet.photo) pet.photo = "immagini/fallback.jpg"
...
const allButtons = document.querySelectorAll(".selezione-pagina2 button")
